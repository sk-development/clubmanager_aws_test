...
# Api gateway properties -> generated
APIGATEWAY_API_ID=<TODO>
APIGATEWAY_API_BASE_URL_ID=<TODO>
APIGATEWAY_AUTHORIZER_ID=<TODO>
APIGATEWAY_API_RESOURCE_ID_SURVEYS=<TODO>